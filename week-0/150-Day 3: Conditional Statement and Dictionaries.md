...
* Example: Python program to detect if a number is even. (sign % tells us the remainder of an expression. Any number that has a remainder 0 after dividing by 2 must be even.)  
...
* For looping through a dictionary, we use a method called items( ). Similar to enumerate, it gives us both the keys and values of a dictionary.  
...
1. Write a program to read the age of a candidate and determine whether it is eligible for casting his/her own vote.
1. Write a Python program to add a key to a dictionary.  
Sample Dictionary : {0: 10, 1: 20}  
Expected Result : {0: 10, 1: 20, 2: 30}
1. Below are the two lists, convert it into a dictionary. keys = \['Ten', 'Twenty', 'Thirty']  
values = \[10, 20, 30]  
Expected output:  
